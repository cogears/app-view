...
<template>
    <a class="combobox current frame border" ref="self"
        :class="{ focus: temp.dropVisible, disabled: disabled, readonly: readonly, frameless: frameless }"
        @click="onShowDropMenu">
